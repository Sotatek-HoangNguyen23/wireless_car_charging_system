...
namespace _Arduino_ChargingPoint1
{
    ...
    {
        private static string myCnn = "Server=TONY\\SQLEXPRESS;Database=WCCS;User Id=sa;Password=123456";
    ...
    ORDER BY ABS(DATEDIFF(SECOND, start_time, GETDATE())) ASC";
        ...
        static void UpdateBalance(string step_cost, string user_id)
        {
            ...
            try
            {
                string updateQuery = "UPDATE [balance] SET balance = balance - @step_cost WHERE user_id = @userId";
